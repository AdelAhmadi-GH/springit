...
public class LinkController {
    ...
    // ************ CRUD operations for Link entity ************//
    ...
    // links in this case.
    // The method currently returns an empty list, indicating that it does not yet
    ...
    // In this case, it maps the method createLink() to the HTTP PUT request at the
    // URL "/links/create".
    // This method is typically used to create a new resource, such as a new link in
    // this case.
    // The method currently returns null, indicating that it does not yet implement
    ...
    public Optional<Link> read(@PathVariable("id") Long linkId) {
        ...
        // If the link with the specified ID is found, it returns an Optional containing
        // the Link entity.
        // If the link is not found, it returns an empty Optional.
        // You can handle the empty Optional case in your application logic as needed.
        // This method retrieves a specific Link entity by its ID.
    ...
    @PutMapping("/{id}")
    // The @PutMapping annotation is used to handle HTTP PUT requests.
    // In this case, it maps the method updateLink() to the HTTP PUT request at the
    public Link updateLink(@PathVariable("id") Long linkId, @ModelAttribute Link link) {
        // URL "/links/{id}".
        ...
        // If the link with the specified ID is not found, it throws a RuntimeException
    ...
    // In this case, it maps the method deleteLink() to the HTTP DELETE request at
